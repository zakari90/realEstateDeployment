  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        ...
        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
          ...
          <li>
            ...
            >
              ...
              <svg className="h-8 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path 
              fillRule="evenodd"
          ...
          <li>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1">{footerSection("email")}</span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 text-gray-700">{footerSection("phoneNumber")} </span>
              </a>
            </li>
    ...
    {/* <div className="mt-12 border-t border-gray-100 pt-6">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        ...
        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; {currentYear} {footerSection("copyright")}</p>
      </div>
    </div> */}
  </div>
</footer>
